...
class CollapseWidgetState extends State<CollapseWidget> {
  // 内容左右padding
  ...
  void didChangeDependencies() {
    ...
    border = Divider(height: 1, color: Colors.grey);
  }
          ...
          child: Row(
              children: [
                ...
                Transform.rotate(
                    ...
                    child: Icon(Icons.arrow_forward_ios, size: 26.0, color: Color(0xff969799))
                )
              ]
          )
      );
